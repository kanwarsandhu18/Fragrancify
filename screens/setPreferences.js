...
const SetPreferences = () => {
  ...
  const [budget, setBudget] = useState(100); // Default budget value
  const [perfumeStrength, setPerfumeStrength] = useState("medium");

  const handleSelection = () => {
    // You can implement your logic here based on the selected parameters
  ...
  return (
    <View style={{ padding: 10, marginVertical: 10 }}>
      ...
      <View>
        <Text style={{ fontSize: 20, fontWeight: "300", color: "#F27575" }}>
          Gender:
        </Text>
        <Picker
